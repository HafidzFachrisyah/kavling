...
<div class="row">
  ...
  <tr>
      ...
      <td></td>
      <td align="center"><a href="<?=base_url('transaksi_kredit/detail');?>" class="btn btn-danger btn-xs" > <i class="fas fa-eye"></i> Lihat</a></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center"><button onclick="lihatdetail('10')" class="btn btn-xs btn-danger"><i class="fas fa-eye"></i>  Lihat</button></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center"><button onclick="lihatdetail('11')" class="btn btn-xs btn-danger"><i class="fas fa-eye"></i>  Lihat</button></td>
    </tr>
    ...
    <!-- <tr>
      ...
      <td></td>
      <td align="center"><a onclick="proses()" class="btn btn-xs btn-danger">Detail</a></td>
    </tr> -->
    ...
    <tr>
      ...
      <td align="center"><button onclick="lihatdetail('1')" class="btn btn-xs btn-danger"><i class="fas fa-eye"></i>  Lihat</button></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center"><button onclick="lihatdetail('2')" class="btn btn-xs btn-danger"><i class="fas fa-eye"></i>  Lihat</button></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center"><button onclick="lihatdetail('3')" class="btn btn-xs btn-danger"><i class="fas fa-eye"></i>  Lihat</button></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center"><button onclick="lihatdetail('4')" class="btn btn-xs btn-danger"><i class="fas fa-eye"></i>  Lihat</button></td>
    </tr>
          ...
          <div class="col-6">
            <!-- small box -->
            <div class="small-box border border-5 border-danger">
              <div class="inner">
              ...
              <a href="#" class="small-box-footer  bg-danger">Detail Data <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-6">
