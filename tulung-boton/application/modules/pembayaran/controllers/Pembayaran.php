...
// 		$kate = $this->db->query("SELECT * FROM kategori WHERE id_customer='$idCust'")->row_array();
	...
	function cetak_rekap($id_kavling){
		...
		$this->mypdf->Cell(5,3,'',0,0,'C', 1);
		$this->mypdf->Cell(45,3,'- Apabila ada yang mengaku-ngaku petugas kami "Arkha Kavling" meminta/menagih pembayaran angsuran "HATI-HATI PENIPUAN".',0,1,'L');
		$this->mypdf->Cell(5,3,'',0,0,'C', 1);
		$this->mypdf->Cell(45,3,'- Konsumen bisa menanyakan/menghubungi informasi "Arkha Kavling" 0821 1823 0919.',0,1,'L');
