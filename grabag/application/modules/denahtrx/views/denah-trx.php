...
viewBox="0 0 27287.22 23325.81"
 ...
 <defs>
  <style type="text/css">
   <![CDATA[
    .str0 {stroke:#373435;stroke-width:21.49;stroke-miterlimit:22.9256}
    .fil0 {fill:none}
    .fil1 {fill:#FEFEFE}
    .fil2 {fill:#332C2B}
    .fil3 {fill:#757475}
    ...
    if($pt->jenis_map == 'polygon'){
      ...
      $x = $y = 0; // For those running with Notices on...
        ...
        $poly = explode(",",$poly0);
         ...
         if($pt->status =='0'){
            echo '<a href="'.base_url('transaksi/daridenah/'.$pt->id_kavling.'/'.$pt->status).'">';
          }elseif($pt->status =='1'){
        ...
        <g id="_2388702558416">
          ...
          <text x="'.$x.'" y="'.$y.'"  class="fil7 fnt1" style="font-size:25rem !important;">'.$pt->kode_kavling.'</text>
            </g>
        </g>
      </a>';
      ...
      //  $('#form')[0].reset(); // reset form on modals
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('[id="lokasi"]').text(data.kode_kavling);
               $('[id="panjang"]').text(data.panjang);
               $('[id="lebar"]').text(data.lebar);
               $('[id="luas"]').text(data.luas_tanah);
               $('[id="harga"]').text(data.harga_jual);
              //  $('[id="status_kav"]').text('Kosong');
               ...
               if(data.status == '0'){
                  ...
                  $('[id="status_kav"]').text('Booking');
                  // $('#kosong').hide();
               }else if(data.status == '2'){
                  $('[id="status_kav"]').text('Terjual Cash');
                  // $('#kosong').hide();
               }else if(data.status == '3'){
                  $('[id="status_kav"]').text('Terjual Kredit');
                  // $('#kosong').hide();
               }
              
               $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
               $('.modal-title').text('Detail Kavling : ' + data.kode_kavling); // Set title to Bootstrap modal title
        ...
        <div class="modal-content">
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      ...
                      <td align="right"><span class="badge badge-success" id="lokasi"></span></td>
                    </tr>
                    
                    <tr>
                      <td>Panjang</td>
                      <td align="right" id="panjang"></td>
                    </tr>
                    <tr>
                      <td>Lebar</td>
                      <td align="right" id="lebar"></td>
                    </tr>
                    <tr>
                      <td>Luas Tanah</td>
                    ...
                    <tr>
                      <td>Harga Cash</td>
                      <td align="right" id="harga"></td>
                    </tr>
                    <tr>
                      <td>Status Kavling</td>
                      <td align="right" ><span class="badge badge-warning" id="status_kav"></span></td>
                    </tr>
            ...
            <!-- /.card -->
              ...
              <div class="col-md-5">
                ...
                <div id="kosong">
                  Status Kavling Masih tersedia <br>
                  <button class="btn btn-sm btn-primary" onclick="trxbaru()">Buat Transaksi Baru</button>
                </div>
