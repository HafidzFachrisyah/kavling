            ...
            <div class="col-sm-7">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td align="right"><?php echo rupiah( $sisa = $totHutang  - $cekDP['jumlah_bayar']); ?></td>
                  <td></td>
                </tr>
                <?php 
                ...
                for ($i=1; $i <= $kaliBayar['kali']; $i++) { 
                  ...
                  $query = "SELECT * FROM pembayaran WHERE pembayaran_ke='$i' AND id_kavling='$id_kavling'";
                    ...
                    $link_kirim = ' <button class="btn btn-xs btn-info" onclick="kirim('.$bayar['id_pembayaran'].')" > Kirim Kwitansi</button>';
                    echo '<tr>
                      <td>Cicilan ke '.$i.'</td>
                      ...
                      <td><a class="btn btn-primary btn-xs" href="'.base_url('pembayaran/cetak/'.$bayar['id_pembayaran']).'" target="_blank">Cetak</a> '.$link_kirim.'</td>
                    </tr>';
